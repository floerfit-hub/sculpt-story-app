export const en = {
  ...
  auth: {
    ...
    resetPasswordSentDesc: "We sent a password reset link to your email",
    resetEmailSentTo: "Reset link sent to",
  ...
  templates: {
    ...
    addDay: "Add day",
    dayName: "Day name",
    dayNamePlaceholder: "e.g. Back Day",
    deleteDay: "Delete day",
    sendToAll: "Send to all clients",
    sentToAll: "Template sent to all clients! 📤",
    workoutPlan: "Workout Plan",
    chooseDay: "Choose a day",
    fromAdmin: "From admin",
    startTrainingByProgram: "Start training by program",
    noAssignedPrograms: "No assigned programs",
    dismissProgram: "Dismiss",
    program: "Program",
    daysCount: "days",
  },
