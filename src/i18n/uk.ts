...
export const uk: Translations = {
  ...
  calc: {
    ...
    hints: {
      ...
      pace_slow: "✅ Рекомендовано. Мінімізує втрату м'язів (сушка) або набір жиру (набір).",
      pace_moderate: "Збалансований підхід. Хороші результати з прийнятними компромісами.",
      pace_aggressive: "⚠️ Швидші результати, але вищий ризик втрати м'язів або зайвого жиру.",
      pace_slow_gain: "✅ Рекомендовано. Мінімальний набір жиру, чистий м'язовий ріст. Профіцит ~10%.",
      pace_moderate_gain: "Хороший баланс між швидкістю набору та контролем жиру. Профіцит ~12.5%.",
      pace_aggressive_gain: "⚠️ Швидкий набір, але значна частина буде жиром. Рекомендуємо повільний або помірний темп.",
      pace_slow_loss: "✅ Рекомендовано. Максимальне збереження м'язів. Дефіцит ~15%.",
      pace_moderate_loss: "Хороший темп схуднення з прийнятною втратою м'язів. Дефіцит ~17.5%.",
      pace_aggressive_loss: "⚠️ Швидке схуднення, але високий ризик втрати м'язів та зниження метаболізму. Рекомендуємо повільний або помірний.",
      pace_slow_maintain: "Мінімальні зміни калорійності для повільної рекомпозиції тіла.",
      pace_moderate_maintain: "Збалансований підхід до підтримки поточної форми.",
      pace_aggressive_maintain: "На підтримці агресивний темп не потрібен — оберіть набір або сушку.",
      goal_gain: "Профіцит калорій для росту м'язів. Деякий набір жиру неминучий.",
      goal_maintenance: "Їжте на підтримці для повільної рекомпозиції — жироспалювання, набір м'язів.",
      goal_loss: "Дефіцит калорій для жиросгоряння. Пріоритет білка для збереження м'язів.",
    },
  },
