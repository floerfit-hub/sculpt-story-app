...
export const uk: Translations = {
  ...
  auth: {
    ...
    forgotPasswordDesc: "Введіть email і ми надішлемо посилання для скидання",
    resetPasswordSentDesc: "Ми надіслали посилання для скидання паролю на вашу пошту",
    resetEmailSentTo: "Посилання надіслано на",
    ...
    passwordChangedDesc: "Ваш пароль було успішно оновлено",
    goToDashboard: "На головну",
    newPasswordTitle: "Новий пароль",
    newPasswordDesc: "Введіть ваш новий пароль",
  ...
  templates: {
    ...
    templateNamePlaceholder: "напр. Спина + Біцепс, День жимів...",
    ...
    noTemplates: "Шаблонів ще немає. Створіть для швидкого старту!",
    copy: "копія",
    duplicateLastWorkout: "Повторити останнє тренування",
    noLastWorkout: "Немає попереднього тренування",
    prevWorkout: "Попереднє тренування",
    noPrevData: "Немає попередніх даних",
    maxWeight: "Макс. вага",
    maxReps: "Макс. повт.",
    avgWeight: "Сер. вага",
    singleDay: "Один день",
    multiDay: "План на кілька днів",
    addDay: "Додати день",
    dayName: "Назва дня",
    dayNamePlaceholder: "напр. День спини",
    deleteDay: "Видалити день",
    sendToAll: "Розіслати усім клієнтам",
    sentToAll: "Шаблон розіслано всім клієнтам! 📤",
    workoutPlan: "План тренування",
    chooseDay: "Оберіть день",
    fromAdmin: "Від адміна",
    startTrainingByProgram: "Почати тренування за програмою",
    noAssignedPrograms: "Немає призначених програм",
    dismissProgram: "Приховати",
    program: "Програма",
    daysCount: "днів",
  },

  install: {
    title: "Встанови додаток",
    step1: 'Натисни "Поширити" (іконка ↑)',
    step2: 'Обери "На початковий екран"',
    step3: 'Натисни "Додати"',
    gotIt: "Зрозуміло",
    installButton: "Встановити додаток",
    androidDesc: "Встановіть для швидкого доступу та офлайн-режиму",
  },
