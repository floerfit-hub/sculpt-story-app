...
export const uk: Translations = {
  ...
  calc: {
    ...
    hints: {
      ...
      steps_8000_12000: "Чудовий рівень активності для жиросгоряння та здоров'я.",
      ...
      train_34: "Оптимальна частота для більшості цілей — набору м'язів чи жиросгоряння.",
      ...
      goal_gain: "Їсте більше норми для росту м'язів. Трохи жиру теж набереться — це нормально.",
